...
from chatflow_ai.dialogue_understanding.flow import FlowExecutor, FlowsList
from chatflow_ai.dialogue_understanding.stack.stack_frame import FlowStackFrame
...
class FlowPolicy(Policy):
            ...
            for _ in range(max_iterations):
                ...
                if result.slot_to_collect:
                    ...
                    for key, value in result.metadata.items():
                        if key not in prediction_metadata:
    ...
    def _build_action_metadata(
        ...
        Args:
            ...
            step_metadata: Flow step 上声明的额外元数据
    ...
    def _preset_slot_to_collect_if_needed(
        ...
        # 检查下一步是否是 collect 步骤
        from chatflow_ai.dialogue_understanding.flow.flow import StepType
