...
from chatflow_ai import __version__
from chatflow_ai.shared.constants import DEFAULT_SERVER_PORT


# 自定义Click组，用于美化帮助信息
class ChatFlowCLI(click.Group):
    ...
    def format_help(self, ctx: click.Context, formatter: click.HelpFormatter) -> None:
        ...
        formatter.write_text(
            "ChatFlow AI - 通用版对话系统 CLI\n"
            "LLM驱动的对话系统，适用于多场景对话应用。"
        )
        formatter.write_paragraph()
...
def print_version(ctx: click.Context, param: click.Parameter, value: bool) -> None:
    ...
    click.echo(f"ChatFlow AI Version : {__version__}")
...
def cli(ctx: click.Context, verbose: bool, debug: bool) -> None:
    ...
    LLM驱动的通用版对话系统。
    使用 'chatflow <command> --help' 查看各命令的详细帮助。
    """
    # 确保ctx.obj存在
...
def main(args: Optional[list] = None) -> None:
    ...
    try:
        # 导入并注册子命令
        from chatflow_ai.cli.init import init_command
        from chatflow_ai.cli.train import train_command
        from chatflow_ai.cli.run import run_command
