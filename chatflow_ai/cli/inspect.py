...
def inspect_command(
    ...
    示例:
        chatflow inspect
        chatflow inspect --model ./my_bot --port 5005
        chatflow inspect --no-browser
    """
    ...
    click.echo("=" * 50)
    click.echo("ChatFlow AI - Inspect 调试页面")
    click.echo("=" * 50)
    ...
    try:
        ...
        from chatflow_ai.api.server import ChatFlowServer
