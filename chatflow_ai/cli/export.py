...
def export_command(
    ...
    示例:
        chatflow export --output ./export/model.tar.gz
        chatflow export --format zip --output ./export/model.zip
        chatflow export --format json --output ./export/domain.json
    """
