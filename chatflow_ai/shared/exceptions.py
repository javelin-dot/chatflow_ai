...
class ConfigurationException(ChatFlowException):
    """配置异常
...
class ModelNotFound(ChatFlowException):
    """模型未找到异常
...
class ModelLoadException(ChatFlowException):
    """模型加载异常
...
class ModelTrainingException(ChatFlowException):
    """模型训练异常
...
class LLMException(ChatFlowException):
    """LLM异常基类
...
class TrackerStoreException(ChatFlowException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(ChatFlowException):
    """对话理解异常基类
...
class ActionException(ChatFlowException):
    """Action异常基类
...
class ChannelException(ChatFlowException):
    """通道异常基类
...
class GraphException(ChatFlowException):
    """图引擎异常基类
...
class RetrievalException(ChatFlowException):
    """检索异常基类
...
class ValidationException(ChatFlowException):
    """验证异常基类
